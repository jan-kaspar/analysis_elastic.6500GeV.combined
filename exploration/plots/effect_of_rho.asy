...
dirs.push("a=1.84E+09,b1=10.20,b2=0.00,b3=0.00,constant,p0=+1.43,KL"); d_pens.push(red); d_labels.push("$\rh = 0.14$");
dirs.push("a=1.84E+09,b1=10.20,b2=0.00,b3=0.00,constant,p0=+1.47,KL"); d_pens.push(blue); d_labels.push("$\rh = 0.10$");
dirs.push("a=1.84E+09,b1=10.20,b2=0.00,b3=0.00,constant,p0=+1.51,KL"); d_pens.push(heavygreen); d_labels.push("$\rh = 0.06$");

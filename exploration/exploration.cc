...
void SampleOne(HadronicFitModel *fm)
{
	int color = 1;
...
int main()
{
	...
	if (false)
	{
		...
		a_p_ka.clear();
		a_p_ka.push_back(1.5);
		a_p_ka.push_back(2.);

		a_p_tm.clear();
		a_p_tm.push_back(-0.3);
		a_p_tm.push_back(-0.2);

		RunPeripheralExploration("exploration3.root", a_a, a_b1, a_b2, a_b3, a_p0, a_p_A, a_p_ka, a_p_tm);
	}
	...
	if (false)
	{
		...
		a_b1.clear();
		a_b1.push_back(+10.637);

		a_b2.clear();
		a_b2.push_back(+4.091);

		a_b3.clear();
		a_b3.push_back(+10.114);
		...
		RunExploration("exploration4.root", a_a, a_b1, a_b2, a_b3, a_pm, a_p0, a_cm);
	}
